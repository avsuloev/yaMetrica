...
trait YaMetrikaAdaptDataTrait
{
    /**
     * Данные для графика Highcharts › Basic line
     */
    protected function adaptVisitsViewsUsers(): void
    {
     ...
     */
    protected function adaptTopPageViews(): void
    {
        $dataArray = [];
     ...
     */
    protected function adaptSourcesSummary(): void
    {
        $dataArray = [];
     ...
     */
    protected function adaptSourcesSearchPhrases(): void
    {
        $dataArray = [];
     ...
     */
    protected function adaptTechPlatforms(): void
    {
        $dataArray = [];
     ...
     */
    protected function adaptVisitsUsersSearchEngine(): void
    {
        $dataArray = [];
     ...
     */
    protected function adaptVisitsViewsPageDepth(): void
    {
     ...
     */
    protected function adaptGeoArea(): void
    {
        $this->adaptGeoPie();
    }
     ...
     * Вызов общего метода adaptGeoPie()
     */
    protected function adaptGeoCountry(): void
    {
        $this->adaptGeoPie();
    }
     ...
     */
    protected function adaptGeoPie(): void
    {
        ...
        //Количество уникальных стран/областей
        $cnt = count($idArray);
